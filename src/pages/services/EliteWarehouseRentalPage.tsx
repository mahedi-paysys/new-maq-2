        ...
        <div className="relative z-10 container-main">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white leading-tight tracking-tight max-w-2xl">
              Elite Warehouse <span className="text-brand">For Rental</span>
            </h1>
            <p className="mt-5 text-white/60 text-lg max-w-lg leading-relaxed">
              Premium warehousing units available for lease at M-10 motorway, Karachi — Pakistan's first SBCA approved warehouse system.
            </p>
          </motion.div>
        </div>
      </section>
              ...
              <div className="relative rounded-3xl overflow-hidden group">
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <div className="inline-flex items-center gap-3 bg-black/50 backdrop-blur-md rounded-2xl px-5 py-3 border border-white/10">
                    ...
                    <span className="text-sm text-white font-medium">Available for Lease — M-10 Motorway</span>
                  </div>
                </div>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.15}>
              <div>
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-ink leading-tight mb-8">
                  Rental <span className="text-brand">Features</span>
                </h2>
